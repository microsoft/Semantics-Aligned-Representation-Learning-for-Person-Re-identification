...
def argument_parser():
    ...
    # ************************************************************
    parser.add_argument('--max-epoch', default=300, type=int,     # Jinx: 60-->300
                        help="maximum epochs to run")
    parser.add_argument('--warm-up-epoch', default=20, type=int,     # Jinx add
                        help="epochs to warm up")
    parser.add_argument('--start-epoch', default=0, type=int,
                        help="manual epoch number (useful when restart)")
    parser.add_argument('--stepsize', default=[40, 80, 120, 160, 200, 240, 280], nargs='+', type=int,    # Jinx: [20, 40]-->...
                        help="stepsize to decay learning rate")
    parser.add_argument('--gamma', default=0.5, type=float,   # Jinx: 0.1 --> 0.5
